...
This theme has an option to override some of the Expressive-Code block/frame styles, to make them fit more with the DaisyUI themes. It's quite difficult to demonstrate this and also have the theme switcher active, so here are a few screenshots showing the effect.

**DaisyUI: Haloween, Expressive-Code: ayu-dark:**
![screenshot showing an example Expressive-Code block, using the Halloween DaisyUI theme and ayu-dark Expressive-Code/shiki theme](images/halloween_ayu-dark.png "halloween & ayu-dark")
**DaisyUI: Garden, Expressive-Code: github-light-high-contrast:**
![screenshot showing an example Expressive-Code block, using the Garden DaisyUI theme and github-light-high-contrast Expressive-Code/shiki theme](images/garden_github-light-high-contrast.png "garden & github-light-high-contrast")
**DaisyUI: Dim, Expressive-Code: material-theme:**
![screenshot showing an example Expressive-Code block, using the Dim DaisyUI theme and material-theme Expressive-Code/shiki theme](images/dim_material-theme.png "dim & material-theme")
**DaisyUI: Lemonade, Expressive-Code: snazzy-light:**
![screenshot showing an example Expressive-Code block, using the Lemonade DaisyUI theme and snazzy-light Expressive-Code/shiki theme](images/lemonade_snazzy-light.png "lemonade & snazzy-light")
**DaisyUI: Dracula, Expressive-Code: dracula:**
![screenshot showing an example Expressive-Code block, using the Dracula DaisyUI theme and dracula Expressive-Code/shiki theme](images/dracula_dracula.png "dracula & dracula")
